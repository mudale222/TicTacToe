    ...
    class Program {
        ...
        class Graphic {
            ...
            public static void PrintWelcomeAndGetParams() {
                ...
                Console.WriteLine("Please enter the MAX DEPTH for minMax algo (more then 11 will take very long time!!):");
        ...
        class Algo {
            ...
            private void TryWin() {
                ...
                Console.WriteLine("MOVE:   X - " + move.x + "    Y - " + move.y + "   Score: " + move.score + "    MinMaxCounter: " + MINMAXCOUNTER + "  Biggest depth: " + BIGGESTDEPTH);
